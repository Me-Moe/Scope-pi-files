...
while True:
    ...
    leftButton = Button(dialogWindow, text='<<Tips', width=8, height=10, bg='light goldenrod', fg='black', activebackground='light goldenrod', activeforeground='black', command=leftButtonAction).place(x=0,y=110)
    rightButton = Button(dialogWindow, text='>>Tips', width=10, height=10, bg='light goldenrod', fg='black', activebackground='light goldenrod', activeforeground='black', command=rightButtonAction).place(x=365,y=110)
